...
```bash
fileEm wos add -f /path/to/paper.pdf -d 10.1000/xyz123
```

Give it the path to the PDF and its DOI; FileEM fetches the paper's metadata from
Semantic Scholar and stores it (title, authors, journal, year, abstract, path, etc.)
